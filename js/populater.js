...
function createAlbBtns() {
  ...
  albumOpts.classList.add("album-opts");

  const playBtn = document.createElement("button");
  playBtn.classList.add("play-btn-white");
  playBtn.textContent = "‎ ▶ ‎";

  const fllwBtn = document.createElement("button");
  fllwBtn.classList.add("fllw-btn-smll");
  fllwBtn.textContent = "♡";

  const extOptBtn = document.createElement("button");
  extOptBtn.classList.add("extra-opt-btn");
  extOptBtn.textContent = "…";
